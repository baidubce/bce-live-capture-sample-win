...
typedef enum {
  ...
  GST_BUFFER_FLAG_NON_REF       = (GST_MINI_OBJECT_FLAG_LAST << 8),
  GST_BUFFER_FLAG_NON_CLOSED_GOP    = (GST_MINI_OBJECT_FLAG_LAST << 9),
  GST_BUFFER_FLAG_LAST       = (GST_MINI_OBJECT_FLAG_LAST << 10)
} GstBufferFlag;
